...
yc=yuan.cpp $(ycmode_lexer) $(ycmode_synatax) $(ycmode_analysis) $(ycmode_mysql)
...
yh=lexer.h token.h debug.h $(yhmode_lexer) $(yhmode_synatax) $(yhmode_analysis) $(yhmode_mysql)
#yhmode_lexer=lexer/token_num.h lexer/lexer_select.h
#yhmode_synatax=synatax.h synatax_tree.h synatax/meta_map.hpp synatax/synatax_ptr.h
#yrc=
#yo=

ljc=Sources Sources/lexer Sources/synatax Sources/analysis Sources/mysql_connect
ljh=Headers
#ljr=Resources
#ljo=Others
