...
{
  virtual std::vector<token_class::bnf_token> do_that(std::vector<token_class::bnf_token> bnf_st={token_class::bnf_token::S},std::vector<token_class::token*> op_st={})=0;
  virtual std::vector<token_class::bnf_token> ret_fun(token_class::bnf_token bt,token_class::token tok)=0;
